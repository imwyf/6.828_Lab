		 ...
		 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 31 11 80 00 	movsbl 0x801131(%eax),%eax
...
008002de <vprintfmt>:
{
  ...
  800363:	ff 24 8d 80 12 80 00 	jmp    *0x801280(,%ecx,4)
  ...
  80042f:	c7 44 24 08 52 11 80 	movl   $0x801152,0x8(%esp)
  800436:	00 
  ...
  800461:	b8 42 11 80 00       	mov    $0x801142,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bc2:	00 
  800bc3:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800bca:	00 
  800bcb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bd2:	00 
  800bd3:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c15:	00 
  800c16:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800c1d:	00 
  800c1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c25:	00 
  800c26:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c68:	00 
  800c69:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800c70:	00 
  800c71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c78:	00 
  800c79:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cbb:	00 
  800cbc:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800cc3:	00 
  800cc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ccb:	00 
  800ccc:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d0e:	00 
  800d0f:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800d16:	00 
  800d17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1e:	00 
  800d1f:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d61:	00 
  800d62:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800d69:	00 
  800d6a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d71:	00 
  800d72:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800dd6:	00 
  800dd7:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800dde:	00 
  800ddf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de6:	00 
  800de7:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e27:	c7 04 24 6c 14 80 00 	movl   $0x80146c,(%esp)
  ...
  800e3d:	e8 ac f2 ff ff       	call   8000ee <vcprintf>
	cprintf("\n");
  800e42:	c7 04 24 90 14 80 00 	movl   $0x801490,(%esp)
