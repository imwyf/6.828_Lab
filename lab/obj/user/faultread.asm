		 ...
		 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023f:	0f be 84 06 94 ee ff 	movsbl -0x116c(%esi,%eax,1),%eax
  800246:	ff 
  800247:	50                   	push   %eax
...
00800294 <vprintfmt>:
{
  ...
  8002ed:	03 8c 83 24 ef ff ff 	add    -0x10dc(%ebx,%eax,4),%ecx
...
008003a5 <.L32>:
  ...
  8003c2:	52                   	push   %edx
  8003c3:	8d 83 b5 ee ff ff    	lea    -0x114b(%ebx),%eax
  8003c9:	50                   	push   %eax
  8003ca:	56                   	push   %esi
  ...
  8003de:	50                   	push   %eax
  8003df:	8d 83 ac ee ff ff    	lea    -0x1154(%ebx),%eax
  8003e5:	50                   	push   %eax
  8003e6:	56                   	push   %esi
...
008003fa <.L36>:
  ...
  80040a:	8d 83 a5 ee ff ff    	lea    -0x115b(%ebx),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b95:	8d 83 7c f0 ff ff    	lea    -0xf84(%ebx),%eax
  800b9b:	50                   	push   %eax
  800b9c:	6a 23                	push   $0x23
  800b9e:	8d 83 99 f0 ff ff    	lea    -0xf67(%ebx),%eax
  800ba4:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bfa:	57                   	push   %edi
  800bfb:	50                   	push   %eax
  800bfc:	8d 83 a8 f0 ff ff    	lea    -0xf58(%ebx),%eax
  800c02:	50                   	push   %eax
  ...
  800c0f:	e8 06 f5 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800c14:	8d 83 88 ee ff ff    	lea    -0x1178(%ebx),%eax
