		 ...
		 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800253:	0f be 84 06 f4 f0 ff 	movsbl -0xf0c(%esi,%eax,1),%eax
  80025a:	ff 
  80025b:	50                   	push   %eax
...
008002a8 <vprintfmt>:
{
  ...
  800301:	03 8c 83 ac f1 ff ff 	add    -0xe54(%ebx,%eax,4),%ecx
...
008003b9 <.L32>:
  ...
  8003d6:	52                   	push   %edx
  8003d7:	8d 83 15 f1 ff ff    	lea    -0xeeb(%ebx),%eax
  8003dd:	50                   	push   %eax
  8003de:	56                   	push   %esi
  ...
  8003f2:	50                   	push   %eax
  8003f3:	8d 83 0c f1 ff ff    	lea    -0xef4(%ebx),%eax
  8003f9:	50                   	push   %eax
  8003fa:	56                   	push   %esi
...
0080040e <.L36>:
  ...
  80041e:	8d 83 05 f1 ff ff    	lea    -0xefb(%ebx),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ba9:	8d 83 04 f3 ff ff    	lea    -0xcfc(%ebx),%eax
  800baf:	50                   	push   %eax
  800bb0:	6a 23                	push   $0x23
  800bb2:	8d 83 21 f3 ff ff    	lea    -0xcdf(%ebx),%eax
  800bb8:	50                   	push   %eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c3e:	8d 83 04 f3 ff ff    	lea    -0xcfc(%ebx),%eax
  800c44:	50                   	push   %eax
  800c45:	6a 23                	push   $0x23
  800c47:	8d 83 21 f3 ff ff    	lea    -0xcdf(%ebx),%eax
  800c4d:	50                   	push   %eax
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c94:	8d 83 04 f3 ff ff    	lea    -0xcfc(%ebx),%eax
  800c9a:	50                   	push   %eax
  800c9b:	6a 23                	push   $0x23
  800c9d:	8d 83 21 f3 ff ff    	lea    -0xcdf(%ebx),%eax
  800ca3:	50                   	push   %eax
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cea:	8d 83 04 f3 ff ff    	lea    -0xcfc(%ebx),%eax
  800cf0:	50                   	push   %eax
  800cf1:	6a 23                	push   $0x23
  800cf3:	8d 83 21 f3 ff ff    	lea    -0xcdf(%ebx),%eax
  800cf9:	50                   	push   %eax
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d40:	8d 83 04 f3 ff ff    	lea    -0xcfc(%ebx),%eax
  800d46:	50                   	push   %eax
  800d47:	6a 23                	push   $0x23
  800d49:	8d 83 21 f3 ff ff    	lea    -0xcdf(%ebx),%eax
  800d4f:	50                   	push   %eax
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d96:	8d 83 04 f3 ff ff    	lea    -0xcfc(%ebx),%eax
  800d9c:	50                   	push   %eax
  800d9d:	6a 23                	push   $0x23
  800d9f:	8d 83 21 f3 ff ff    	lea    -0xcdf(%ebx),%eax
  800da5:	50                   	push   %eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800e0e:	8d 83 04 f3 ff ff    	lea    -0xcfc(%ebx),%eax
  800e14:	50                   	push   %eax
  800e15:	6a 23                	push   $0x23
  800e17:	8d 83 21 f3 ff ff    	lea    -0xcdf(%ebx),%eax
  800e1d:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e54:	57                   	push   %edi
  800e55:	50                   	push   %eax
  800e56:	8d 83 30 f3 ff ff    	lea    -0xcd0(%ebx),%eax
  800e5c:	50                   	push   %eax
  ...
  800e69:	e8 c0 f2 ff ff       	call   80012e <vcprintf>
	cprintf("\n");
  800e6e:	8d 83 e8 f0 ff ff    	lea    -0xf18(%ebx),%eax
