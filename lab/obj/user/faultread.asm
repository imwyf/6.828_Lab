		 ...
		 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800256:	0f be 84 06 a4 ee ff 	movsbl -0x115c(%esi,%eax,1),%eax
  80025d:	ff 
  80025e:	50                   	push   %eax
...
008002ab <vprintfmt>:
{
  ...
  800304:	03 8c 83 34 ef ff ff 	add    -0x10cc(%ebx,%eax,4),%ecx
...
008003bc <.L32>:
  ...
  8003d9:	52                   	push   %edx
  8003da:	8d 83 c5 ee ff ff    	lea    -0x113b(%ebx),%eax
  8003e0:	50                   	push   %eax
  8003e1:	56                   	push   %esi
  ...
  8003f5:	50                   	push   %eax
  8003f6:	8d 83 bc ee ff ff    	lea    -0x1144(%ebx),%eax
  8003fc:	50                   	push   %eax
  8003fd:	56                   	push   %esi
...
00800411 <.L36>:
  ...
  800421:	8d 83 b5 ee ff ff    	lea    -0x114b(%ebx),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bac:	8d 83 8c f0 ff ff    	lea    -0xf74(%ebx),%eax
  800bb2:	50                   	push   %eax
  800bb3:	6a 23                	push   $0x23
  800bb5:	8d 83 a9 f0 ff ff    	lea    -0xf57(%ebx),%eax
  800bbb:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c11:	57                   	push   %edi
  800c12:	50                   	push   %eax
  800c13:	8d 83 b8 f0 ff ff    	lea    -0xf48(%ebx),%eax
  800c19:	50                   	push   %eax
  ...
  800c26:	e8 06 f5 ff ff       	call   800131 <vcprintf>
	cprintf("\n");
  800c2b:	8d 83 98 ee ff ff    	lea    -0x1168(%ebx),%eax
