...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800347:	00 
  800348:	c7 44 24 08 18 11 80 	movl   $0x801118,0x8(%esp)
  80034f:	00 
  800350:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800357:	00 
  800358:	c7 04 24 35 11 80 00 	movl   $0x801135,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  8003bc:	00 
  8003bd:	c7 44 24 08 18 11 80 	movl   $0x801118,0x8(%esp)
  8003c4:	00 
  8003c5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003cc:	00 
  8003cd:	c7 04 24 35 11 80 00 	movl   $0x801135,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80040d:	c7 04 24 44 11 80 00 	movl   $0x801144,(%esp)
  ...
  800423:	e8 51 00 00 00       	call   800479 <vcprintf>
	cprintf("\n");
  800428:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004b5:	e8 b4 01 00 00       	call   80066e <vprintfmt>
	sys_cputs(b.buf, b.idx);
		 ...
		 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8005d8:	0f be 80 67 11 80 00 	movsbl 0x801167(%eax),%eax
...
0080066e <vprintfmt>:
{
  ...
  80079f:	c7 44 24 08 7f 11 80 	movl   $0x80117f,0x8(%esp)
  8007a6:	00 
  ...
  8007bf:	c7 44 24 08 88 11 80 	movl   $0x801188,0x8(%esp)
  8007c6:	00 
  ...
  8007f1:	b8 78 11 80 00       	mov    $0x801178,%eax
