...
libmain(int argc, char **argv)
{
  ...
  800072:	8b 55 0c             	mov    0xc(%ebp),%edx
	...
	thisenv = 0;
  800075:	c7 c1 2c 20 80 00    	mov    $0x80202c,%ecx
  80007b:	c7 01 00 00 00 00    	movl   $0x0,(%ecx)
...
0080039e <vprintfmt>:
{
  ...
  8003a7:	e8 ad fc ff ff       	call   800059 <__x86.get_pc_thunk.bx>
...
int vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  800838:	e8 1c f8 ff ff       	call   800059 <__x86.get_pc_thunk.bx>
