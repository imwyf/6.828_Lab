...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  800039:	c7 04 24 00 11 80 00 	movl   $0x801100,(%esp)
  ...
  800051:	c7 04 24 0e 11 80 00 	movl   $0x80110e,(%esp)
		 ...
		 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	e8 4c 0d 00 00       	call   800fa0 <__umoddi3>
  800254:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800258:	0f be 80 2f 11 80 00 	movsbl 0x80112f(%eax),%eax
...
008002ee <vprintfmt>:
{
  ...
  800373:	ff 24 8d 80 12 80 00 	jmp    *0x801280(,%ecx,4)
  ...
  80043f:	c7 44 24 08 50 11 80 	movl   $0x801150,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 40 11 80 00       	mov    $0x801140,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b40:	00 
  800b41:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800b48:	00 
  800b49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b50:	00 
  800b51:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
  800b58:	e8 ae 02 00 00       	call   800e0b <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd2:	00 
  800bd3:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800bda:	00 
  800bdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be2:	00 
  800be3:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
  800bea:	e8 1c 02 00 00       	call   800e0b <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c25:	00 
  800c26:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800c2d:	00 
  800c2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c35:	00 
  800c36:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
  800c3d:	e8 c9 01 00 00       	call   800e0b <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c78:	00 
  800c79:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800c80:	00 
  800c81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c88:	00 
  800c89:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
  800c90:	e8 76 01 00 00       	call   800e0b <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ccb:	00 
  800ccc:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800cd3:	00 
  800cd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cdb:	00 
  800cdc:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
  800ce3:	e8 23 01 00 00       	call   800e0b <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d1e:	00 
  800d1f:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800d26:	00 
  800d27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2e:	00 
  800d2f:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
  800d36:	e8 d0 00 00 00       	call   800e0b <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d71:	00 
  800d72:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800d79:	00 
  800d7a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d81:	00 
  800d82:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
  800d89:	e8 7d 00 00 00       	call   800e0b <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800de6:	00 
  800de7:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800dee:	00 
  800def:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df6:	00 
  800df7:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
  800dfe:	e8 08 00 00 00       	call   800e0b <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e1c:	e8 44 fd ff ff       	call   800b65 <sys_getenvid>
  ...
  800e2f:	89 74 24 08          	mov    %esi,0x8(%esp)
  800e33:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e37:	c7 04 24 6c 14 80 00 	movl   $0x80146c,(%esp)
  800e3e:	e8 1b f3 ff ff       	call   80015e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e43:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e47:	8b 45 10             	mov    0x10(%ebp),%eax
  800e4a:	89 04 24             	mov    %eax,(%esp)
  800e4d:	e8 ab f2 ff ff       	call   8000fd <vcprintf>
	cprintf("\n");
  800e52:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  800e59:	e8 00 f3 ff ff       	call   80015e <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800e5e:	cc                   	int3   
  800e5f:	eb fd                	jmp    800e5e <_panic+0x53>
